                ...
                <div className="col-md-6 mt-5">
                    ...
                    <div className="row features">
                        <div className="col-6 feature-item">
                            ...
                            <p>We don’t just serve food, we serve moments that your family will cherish forever.
                               Every dish we make carries a secret ingredient called love.</p>
                        </div>

                        <div className="col-6 feature-item">
                            <i className="bi bi-people"></i>
                            <p>Good food doesn’t just fill plates; it fills hearts too.
                        ...
                        <div className="col-6 feature-item">
                            <i className="bi bi-people"></i>
                            <p>We serve flavors that make your family time unforgettable.
